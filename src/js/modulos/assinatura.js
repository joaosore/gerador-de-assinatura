...
$('#tel1, #tel2, #ramal').on('input', function() {
	...
	{	
		TEL = '<a href="tel:'+TEL1+'" style="color: #242353;text-decoration: none;padding-left: 10px;" class="phonemask">'+TEL1+'</a><span>';
	}

	if(TEL1.length > 0 && TEL2.length > 0)
	{
		TEL = '<a href="tel:'+TEL1+'" style="color: #242353;text-decoration: none;padding-left: 10px;" class="phonemask">'+TEL1+'</a><span>  | <a href="'+TEL2+'" style="color: #242353;text-decoration: none;" class="phonemask">'+TEL2+'</a>';
	}

	if(RAMAL.length > 0)
	{
		TEL = TEL + '<br /> <a href="'+RAMAL+'" style="color: #242353;text-decoration: none;;padding-left: 10px;">RAMAL: '+RAMAL+'</a>';
	}
	phonemask();
